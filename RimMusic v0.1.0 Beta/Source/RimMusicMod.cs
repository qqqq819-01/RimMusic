...
namespace RimMusic
{
    public class RimMusicMod : Mod
    {
        ...
        public RimMusicMod(ModContentPack content) : base(content)
        {
            ...
            // Standardized engineering log
            Log.Message("[RimMusic] Initialization sequence complete. AI Audio Engine v0.1.0 Beta online.");
        }
    ...
    public class RimMusicSettings : ModSettings
    {
        ...
        public int MinMatchScore = 2;
        public int TargetInstrumentCount = 5;
        public int TargetKeywordCount = 10;
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref MinMatchScore, "MinMatchScore", 2);
            Scribe_Values.Look(ref TargetInstrumentCount, "TargetInstrumentCount", 5);
            Scribe_Values.Look(ref TargetKeywordCount, "TargetKeywordCount", 10);
