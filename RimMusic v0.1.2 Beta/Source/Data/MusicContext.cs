    ...
    public class MusicContext
    {
        ...
        public static MusicContext Build(Pawn forcedFocus = null, bool isRealGeneration = false)
        {
            ...
            if (Current.ProgramState == ProgramState.Playing && Find.CurrentMap != null)
            {
                ...
                float dominateThreshold = RimMusicMod.Settings?.ThreatDominateThreshold ?? 0.75f;
            ...
            if (Find.CurrentMap != null && Current.Game != null)
            {
                ...
                {
                    ctx.culture_instruments = CultureCalculator.CalculateCulturalInstruments(Find.CurrentMap, isRaid, narrativePawn, out dominantVibe);
                }
                else
                {
