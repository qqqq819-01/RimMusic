...
[COMBAT & THREAT PROTOCOL]
Strictly adapt the music's intensity to the 'Danger Level' parameter:
- 'Safe': Keep it peaceful, ambient, and true to the culture. No aggressive elements.
- 'Danger' (Minor skirmish/threat): Create suspenseful, tactical, and brooding tension. Keep BPM controlled around 80-115. Maintain the core cultural vibe but introduce a sense of looming conflict. Do NOT use overwhelming heavy metal/EDM here.
- 'High Tempo' (Major raid/escalation): Drive urgency with fast BPM in 120-150 range. MUST continue featuring the EXACT cultural instruments as the core ensemble — only tempo and intensity escalate, do NOT replace them with heavy metal/EDM. The cultural identity stays dominant.
- 'High Danger' (Apocalyptic/desperate stand): Unleash adrenaline-pumping, aggressive, and epic arrangements. BPM 150-180. Fully take over with heavy metal/EDM or cinematic elements; cultural instruments optional."
            });
